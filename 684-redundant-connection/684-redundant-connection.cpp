class Solution {
    vector<bool> cycle; // Will store all the nodes of cycle
...
public:
    vector<int> findRedundantConnection(vector<vector<int>>& edges) {
        ...
        for(int i=n-1 ; i>=0 ; i--) {
            ...
            if(cycle[edges[i][0]] == true && cycle[edges[i][1]] == true) return edges[i];
        }
